...
subject_constraints = {
    'English': {'Jr. KG': 5, 'Sr. KG': 5, '1': 8},
    'Hindi': {'Jr. KG': 4, 'Sr. KG': 4, '1': 6},
    'Marathi': {'1': 2},
    'Mathematics': {'Jr. KG': 4, 'Sr. KG': 4.5, '1': 7},
    'EVS': {'Jr. KG': 2, 'Sr. KG': 3, '1': 5},
    'Environmental Education': {'Jr. KG': 2, 'Sr. KG': 1, '1': 1},
    'Computer Studies': {'Jr. KG': 0.5, 'Sr. KG': 0.5, '1': 2},
    'Physical Education': {'Jr. KG': 2, 'Sr. KG': 2, '1': 2},
    'Circle Time': {'Jr. KG': 0.5, 'Sr. KG': 0.5, '1': 1},
    'Life Skills': {'Jr. KG': 0.5, 'Sr. KG': 0.5, '1': 1},
    'Art': {'Jr. KG': 2, 'Sr. KG': 2, '1': 2},
    'Clay Modeling': {'Jr. KG': 1, 'Sr. KG': 1, '1': 1},
    'Music': {'Jr. KG': 1, 'Sr. KG': 1, '1': 1},
    'Music T': {'1': 1},
    'Dance': {'Jr. KG': 1, 'Sr. KG': 1, '1': 1},
    'DEED': {'Jr. KG': 1, 'Sr. KG': 0.5, '1': 1},
    'Wonder Time': {'Jr. KG': 0.5, 'Sr. KG': 1, '1': 1},
    'Yoga': {'Jr. KG': 0.5, 'Sr. KG': 0.5, '1': 1},
    'Karate': {'1': 1},
    'Assembly': {'Jr. KG': 1, 'Sr. KG': 0.5, '1': 1},
    'Library': {'Jr. KG': 0.5, 'Sr. KG': 1, '1': 1},
    'Role Play': {'Jr. KG': 0.5},
    'Play Pen': {'Jr. KG': 0.5, 'Sr. KG': 0.5},
    'SGI': {'1': 2},
    'CLASS TESTS': {'1': 1}
}
